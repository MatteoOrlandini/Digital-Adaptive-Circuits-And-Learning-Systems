...
def main():
    ...
    print('Average train loss: {}'.format(avg_loss_tr))
    ...
    avg_loss_val = np.mean(validation_loss)
    print('Average validation loss: {}'.format(avg_loss_val))
    ...
    torch.save({
                ...
                }, "Models/Relation/relation_model_validation_C{}_K{}_60000epi.pt".format(CLASS_NUM, SAMPLE_NUM_PER_CLASS))

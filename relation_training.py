...
def main():
    ...
    for episode in range(EPISODE):
        ...
        samples = samples.view(CLASS_NUM * SAMPLE_NUM_PER_CLASS, 1, *samples.size()[2:])  # (C X K) X 1 X 128 X 51
        batches = batches.view(CLASS_NUM * BATCH_NUM_PER_CLASS, 1, *batches.size()[2:])   # (C X Q) X 1 X 128 X 51
        ...
        print("sample_features.shape after view and sum:", sample_features.shape)
        ...
        print("batch_features.shape after view:", batch_features.shape)
        ...
        print("batch_features_ext.shape after transport:", batch_features_ext.shape)

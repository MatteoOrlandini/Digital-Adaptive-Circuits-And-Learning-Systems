...
\end{equation}
Il processo di training avviene minimizzando il negativo della log-probabilità $J(\phi)=-\log\left(p_\phi(y=k|\mathbf{x})\right)$ considerando la distanza fra query e il prototipo della sua classe.
